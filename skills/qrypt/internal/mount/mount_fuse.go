...
func (fb *fuseMountBackend) mount(ctx context.Context, rc *config.ResolvedMountConfig, drv backend.Driver, cipher *cipher.RcloneCipher, cacheMgr *index.CacheManager) error {
